...
function Row6() {
  return (
    <div className=" min-h-[90vh] bg-sky-100 w-full grid items-center justify-items-center ">
      <div className=" min-h-[60vh] w-[90%]  grid grid-cols-2 ">
        <div className=" flex flex-col gap-5 ">
          ...
          <p>
            Success doesn’t end with training it begins there. Our students go
            ...
            challenges and make meaningful contributions. We take pride in
